...
import { IContentRangeType, IRangeRequestClient, IRangeRequestResponse } from './types';

export { IRangeRequestClient, IRangeRequestResponse, IContentRangeType, IHeadRequestInfo } from './types';
...
export class RangeRequestTokenizer extends AbstractTokenizer {
  ...
  constructor(private rangeRequestClient: IRangeRequestClient, config?: IRangeRequestConfig) {
    super();
    if (config) {
  ...
  public init(): Promise<IRangeRequestResponse> {
  ...
  private _fetchSizeWithHeadRequest(): Promise<IRangeRequestResponse> {

    debug(`_fetchSizeWithHeadRequest()`);
    return this.rangeRequestClient.getHeadInfo().then(info => {
  ...
  private _fetchSizeWithGetRequest(): Promise<IRangeRequestResponse> {
